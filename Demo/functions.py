...
def _calculateResult(search_query, data_frame):
        ...
        # ##########################
        # TO DO TO DO TO DO:
        # Instead of the loops below, one can use the lambda functions f_ANDsearch(df['keyword'],keyword,)
        # This is a dificult problem, which eventualy saves some calc time, but is it worth it?
        # ##########################
...
#        count = [None] * len(parts) # storage to count number of times an onto class is found
        ...
        # Create a string of multiple lines to show the search results in the result screen. 
        # Per article the DOI is shown and sentences where keyword has been found (every new line)
